                    ...
                    $(this).find('section').each(function () {
                        ...
                        $(this).find('product').each(function () {
                            ...
                            if (productSelected[sectionSelected] == i && sectionSelected == j) {
                                htmlString += "<button id='myProduct" + j + i + "' type='button' class='btn btn-lg' style='border-radius:0px; border-color:white' onClick='toggleProducts[" + j + "][" + i + "] = !toggleProducts[" + j + "][" + i + "]; createDownloadBox(" + j + "," + i + ",true);return false;'>" + title + " <span class='badge' id='bag" + j + i + "'>" + numberShownDownloads[j][i] + "</span></</button>";

                            } else if (productSelected[sectionSelected] == undefined) {
                                htmlString += "<button id='myProduct" + j + i + "' type='button' class='btn btn-lg' style='border-radius:0px;' onClick='toggleProducts[" + j + "][" + i + "] = !toggleProducts[" + j + "][" + i + "]; createDownloadBox(" + j + "," + i + ",true);return false;'>" + title + " <span class='badge' id='bag" + j + i + "'>" + numberShownDownloads[j][i] + "</span></</button>";
